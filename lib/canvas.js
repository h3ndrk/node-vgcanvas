...
var VGContext = function() {
	...
	self.fillStyleValue = '#fff';
	self.strokeStyleValue = '#fff';
...
vgcanvas.Gradient.prototype.addColorStop = function(pos, c) {
	c = color(c);
	this.addColorStopRGBA(pos, c.red(), c.green(), c.blue(), c.alpha());
};
...
VGContext.prototype.setStyle = function(type, obj) {
	if(typeof obj === 'string' || obj instanceof String) {
		obj = color(obj);
		vgcanvas.setStyle(type, [obj.red(), obj.green(), obj.blue(), obj.alpha()]);
	} else {
